...
export default function LoginCard({
    ...
    const resolvedSignUpPath = signUpPath !== undefined ? signUpPath : role === "Patient" ? "/patient-register" : "/provider-register";
    ...
    return (
        <div className="w-full max-w-[448px] mx-auto">
            ...
            <div className="bg-white rounded-[16px] p-6 pb-3 shadow-[0px_3.9px_5.86px_-3.9px_#0000001A,0px_9.76px_14.64px_-2.93px_#0000001A]">
                ...
                {
                errors.api && (
                    <p className="text-red-500 text-sm text-start mb-5">
                        {
                        errors.api
                    }</p>
                )
